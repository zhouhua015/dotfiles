...
function M.on_attach(client, bufnr)
    ...
    if client.resolved_capabilities.document_highlight then
        set_highlight('LspReferenceRead', {cterm='underline', ctermfg=5, gui='underline', guifg='SlateBlue'})
        set_highlight('LspReferenceText', {cterm='underline', ctermfg=5, gui='underline', guifg='SlateBlue'})
        set_highlight('LspReferenceWrite', {cterm='underline', ctermfg=5, gui='underline', guifg='SlateBlue'})
